...
## Active priority — Model1 generalization (user update, 2026-09-15)

Model1 is now the primary development and compute priority. Aim for broader real-world
reliability across unseen sources, generator families and processing, while preserving AI
retention and reducing REAL false alarms. "Universal" is a research objective, not a
current capability or a guarantee about every future image. Do not declare it from TRAIN
accuracy, the20 consumed numeric checks, or source names without ancestry evidence.

E92 remains the active full-image demo. E125/E126 did not qualify as replacements.
E131/E134 are separate fresh-head/internal-source diagnostics, not E92 production metrics;
they exposed source shifts and transport instability worth addressing. No current candidate
has established independent unseen-generator generalization.

Model2 remains visibly in the test/research stage. Preserve E129–E135 and their failures,
but do not start further Model2 generation, fitting or dataset acquisition by default.
Keep its outputs separate from the active Model1 decision. Resume substantive Model2
experimentation only when the user reprioritizes it. This priority supersedes earlier
balanced-work and "next Model2" sections below.

E136 completed the paired-processing consistency pilot on12525 existing TRAIN parents,
with exact E131 source-excluding folds/maps. Full-frame social-Q75 AI recall improved
77.74% to79.56% and REAL FPR fell16.39% to16.07%, but30 previously caught AI images became
misses and17 previously correct REAL images became false alerts. Clean REAL FPR also rose.
...
following the user's continuation request; completed process receipts are preserved, without
claiming nine hours of uninterrupted agent activity. No recurring schedule is configured.
E92 remains the serving reference and is restored between registered heavy stages.
...
| E125 center/full-frame correction heads | Both complete and pass TRAIN/runtime guards |0/7930 REAL false alarms and4595/4595 AI per each of4 conditions; not independent evidence |
...
### E123 outcome and E124/E125 execution plan

E123 passed all40 source/class representatives ×4 conditions: old center CLIP parity exactly0 and repeated full-frame parity exactly0,75.76seconds total /71.62seconds measured loop,2.04GiB MPS. This proves operation/feature feasibility, not improved detection. E124 now registers complete12525-parent /50100-view extraction using3-parent windows and CLIP batches3, all old roles and all160 probe-vector replay guards. Durable bound chunks,4-hour per-execution limit,6GiB MPS and20GiB disk reserve; no downloads.

After complete verified E124 output, E125 separately registers and runs BOTH equal-capacity branches: old center-only768 versus full-frame768, each128 PCA coordinates using the previous seed113/power3, appended to frozen E103450 features. Keep578 zero correction coefficients, joint minimax objective,L2.01,SLSQP200 and all AI/correct-REAL/source/numeric/runtime guards. No new cuts or DEV choice. A single one-shot E124/E125 runner logs outcomes and restores E92 after completion/failure. DEV needs a subsequent separate registration; no automatic promotion.

Do not keep searching indefinitely against one consumed640-view screen. This is one additional fixed information-coverage hypothesis. Even a future screen pass needs unconsumed source/generator/parent evidence; repeated development selection has its own overfitting risk. Model2 E122 completes11/16 accepted outputs with no first-nonfinite events;5 are still safety-filter rejected. The complete16/16 gate remains failed. Keep the generation corpus quarantined and investigate output quality/filter behavior before spatial-head training.

E124/E125 execution has started. E124 is the only active GPU experiment; E125 registration/fit waits for complete verified features. Keep current E92 as the eventual restored serving model and require a separate next DEV protocol even if either new TRAIN branch passes.

## E126 — gated full-frame consumed-development comparison (2026-09-15)

Implementation now follows the fixed E124/E125 information-coverage hypothesis. Wait for complete paired E125 TRAIN reports and restored E92; reject incomplete or inconsistent permission before opening any DEV metadata. Only passing branches receive separate SHA-bound E126 registration. Evaluate both when both pass; do not choose a branch from DEV scores. Use the existing 640 original/social views, unchanged cuts and all E114 numeric and individual E43/E92/E103 AI retention / E92/E103 REAL retention guards. Encode batch3 `[old center, full frame, full frame]`, replay the center against E114 raw features and the duplicate full-frame vector within 1e-5, and reuse E83 DINO/pooled CLIP/DEAR. Already transported social images are not compressed a second time. Lock all branch scores before metrics. No gallery/final access or automatic serving change. A finite dependent process will execute once after E124/E125; this is not a recurring automation.

The same consumed screen remains selection-biased and too narrow for a universal claim. A pass would authorize only the next separately registered gallery regression, followed by genuinely unconsumed parent/source/generator evidence. A failure is not permission to sweep thresholds or make a special case for one image.

Model2 next diagnostic: before considering any spatial training, quantify background drift and mask-edge discontinuities in the already generated E122 outputs against E119 authentic and traditional-edit controls. Register a CPU-only audit before measuring pixels. Keep all 16 attempts in the accounting and exclude safety-rejected black placeholders from generated-image quality summaries, with their rejection count explicit. This does not override the failed 16/16 generation gate or admit the 11 accepted outputs to training.

E126 dependent execution has started in the waiting state. Registration remains conditional on the complete verified E125 outcome; no extra user interaction is needed. Current implementation validation: 991 Python tests passed.

### E127 registered-audit design

Implement a read-only CPU pixel audit of the fixed E122 replay. Account for all 16 attempts and all 16 traditional controls; summarize generated-image metrics only for the 11 already accepted E122 outputs, explicitly excluding the 5 filtered placeholders. Before pixels are measured, bind original/control/mask/negative-target PNGs, E122 case receipts and raw/composite PNGs. Normalize channel errors to [0,1]; measure inside/outside MAE, outside RMSE/p95, changed-pixel fractions and four-neighbour mask-crossing RGB gradients relative to authentic. Compare classical edits and AI composites on the same accepted parents. Replay old background-change fractions and exact hard-composite provenance. No detector fit, classification cutoff, GPU inference, admission or semantic-quality claim. Seven targeted metric/mask tests passed before registration.

### E127 decision and remaining Model2 work

The completed CPU audit confirms nonzero raw background drift (mean MAE 0.038381) and exact composite backgrounds. Authentic/classic/composite boundary gradients average 0.030659/0.042073/0.044219 on the same 11 accepted parents; classic edits are essential negatives, and a boundary-only cue is not evidence of AI. Keep the five filtered attempts accounted for and the full corpus quarantined under the failed E122 gate. A subsequent generation-quality/source protocol must precede spatial learning; a future head must report performance separately for mask interiors, boundary bands, authentic backgrounds and non-AI edited regions. Never relabel raw VAE-altered background as pixel-untouched. No new editor/source generalization evidence has been acquired. Full aggregate evidence: `evidence/e127_pixel_audit.json`.

E126 code commit `a3d495a929f5ac293c13f36c9fd657ce9a77d49d` passed GitHub CI run 34896364588. Its finite dependent process still waits for E124/E125; no candidate evaluation or promotion is implied by CI success.

## Active overnight work — 2026-09-15

The user authorized nine hours of continuous work in the current chat, without a recurring schedule. Work window starts 2026-09-14 21:58:48 UTC (2026-09-15 00:58:48 Europe/Istanbul); target end is 2026-09-15 06:58:48 UTC (09:58:48 local). Continue the existing E124/E125 and conditional E126 processes; preserve immutable contracts and record outcomes before choosing the next hypothesis. GPU workloads stay sequential. Use waiting compute time for source/provenance research, CPU diagnostics and implementation/tests. Commit/push completed reviewable changes; preserve failed experiments and current E92 serving until all applicable promotion criteria pass.

### E128/E129 — inpainting input-geometry hypothesis

A read-only visual inspection of an existing E119 native512 source crop showed very strong chromatic high-frequency variation with little scene context. This is a diagnostic observation, not a safety-filter diagnosis or a finding that the authentic label is wrong. The [pinned inpainting model card](https://huggingface.co/stable-diffusion-v1-5/stable-diffusion-inpainting) describes512px LAION-aesthetics training and lossy autoencoding; [Diffusers inpainting guidance](https://huggingface.co/docs/diffusers/v0.36.0/using-diffusers/inpaint) uses resized inputs. Together these motivate an explicit input-preparation ablation, not a new threshold or filter bypass.

Register E128 before preparation: same16 E119 source parents, roles, masks, seeds and licenses; replace the native512 center crop by the complete native center square of side min(width,height), LANCZOS-resized to512. No aspect warp, score-based source selection, new parents or output-driven refill. This changes context and resampling together, so it cannot isolate denoising from field-of-view effects. Prepare matching resized authentic and classical-edit controls; label them resized research derivatives, never native sensor evidence. Record source geometry, exact body hashes and a neighbour-difference texture proxy without treating it as a noise estimate or acceptance filter.

After complete verified E128 preparation, separately register E129: same pinned fp16+SDPA implementation, weights,16 seeds119000–119015, prompt,30 steps,guidance7.5,strength1,512px masks and enabled safety checker as E122. Keep finite tensor checks and full16/16 acceptance (nonblank, filter-negative, >=95% masked pixels changed, background-exact composite). Preserve E122 failed population and evaluate all16 new attempts. This is generation engineering, not detector accuracy or independent proof; no automatic training admission. GPU execution must wait until E124/E125/E126 release the GPU and restore E92.

E128 preparation completed and E129 generation contract is now frozen. The finite dependent E129 runner is ready to follow E124/E125/E126; it verifies exact E92 identity and restores the base serving environment. No recurring schedule. Full16/16 generation acceptance remains necessary before a separate spatial-learning protocol; no E128/E129 detector performance is claimed.
...
## E130 — mask-blind patch-drift baseline design (2026-09-15)

[TRAIL](https://arxiv.org/abs/2608.18968) retains patchwise DINO perturbation responses instead of collapsing them to one image score. Its authors also localize classical edits, so their signal is not intrinsically AI-specific. Their headline system uses a7B encoder and development-selected settings; it is not validation-free. [DinoLizer](https://arxiv.org/abs/2511.20722) supports a later frozen-patch linear head, while distinguishing semantic alteration from autoencoding. Its backbone/training corpus and target convention differ from ours; attaching our old image head to patch tokens would not reproduce it.

Implement E130 as a new diagnostic, without fitting a localizer. Freeze only after the complete E129 report exists. Use the existing small DINOv2-S/14 checkpoint, whole448px square context, block11 one-based (from the [authors' fixed small-model table](https://github.com/VishalJ99/trail-image-edit-localization/blob/0fce0f1de2ac0d219baf91592ee2bca95ec0a219/results/model_family/selected_layers_all16.csv)), two-level global Haar attenuation.2, half-cosine drift, reflect3x3 median and32x32 grids. Repeat grid cells to512 for evaluation; no mask enters inference or per-image score normalization. The half-scaled external headline cut is an explicitly uncalibrated diagnostic operating point, not a transferable probability threshold. Keep a fixed8px boundary band.

Account for all16 authentic and classical-edit controls, original and JPEG75 separately. Score only E129's previously accepted composites and explicitly count rejected attempts; no positive placeholders, survivor refill or training admission. Lock all maps before evaluation-mask access. Report negative false-flag area and interior/boundary/background metrics, plus accepted-parent paired AI-minus-authentic/classical aligned-region AUC differences. The latter describe spatial ranking at corresponding locations, not binary REAL/AI accuracy. Verify finite patch tensors, repeated-original parity<=1e-5, exact hard-composite ancestry and6GiB/2400s resource limits. Retain token/map receipts locally for reproducibility; later use requires another contract.

This can diagnose localization signal even if the generation pilot fails; it does not relax the16/16 gate for registering a trained spatial head. It is a small-model adaptation, not an exact TRAIL reproduction or an independent evaluation. GPU execution waits for E124/E125/E126/E129 and exact E92 restoration. Code is implemented, not yet frozen or executed. Existing E107 and failed E122 remain unchanged. No new model/image download.

## E131 — conservative internal source-holdout diagnostic (2026-09-15)

Metadata inspection of the complete12525-parent TRAIN roster finds40 class/source names but only10 declared connected groups once known dependencies are retained. RR's seven AI topic labels belong to one publisher with its REAL pool. E36's shared AI prompt batch and known FLUX/Qwen/OpenAI/Gemini bridges connect2916 AI parents; other AI-bearing groups are1110 RR and569 CommunityForensics parents. MIDD's767 originals remain together across eight sensors, and SID's128 across two cameras. This is a declared dependency graph, not proof that unknown generator or semantic relationships are absent.

Register a separate TRAIN-internal three-fold diagnostic after E124's complete cache and dependency closure exist. Preserve E53 inherited near-duplicate/source components, known body/pixel/scene links, publishers and declared family/prompt bridges. No connected group is split for balancing. Fixed outer held-out parent counts are REAL/AI2467/2916,2875/1110 and2588/569. All global roles stay TRAIN; old E54 folds/artifacts remain unchanged. This newly fitted analysis cannot turn historically consumed parents into independent evidence.

Compare fresh equal-capacity center/full-frame heads, without E43/E92/E103 fitted projections or correction coefficients. Refit every centering/scaling/PCA step solely on the current outer FIT rows: DINO3072, pooledCLIP1536 and DEAR1640 each64 PCs, plus center/full768 each128 PCs. Whiten with fixed seed131/power3;320 features plus intercept. Fit zero-start convex BCE with fixed L2.01, unpenalized intercept and equal class/component/parent/view mass. L-BFGS-B500,ftol1e-12,gtol1e-7; successful finite solution and maximum gradient<=1e-5 required. Saved subset replay tolerance1e-10 and zero fixed-cut changes. No hyperparameter sweep, DEV fitting or inherited candidate coefficients.

Lock all six branch/fold predictions before held-out metrics. Report each of four transport conditions, fold-specific and pooled scores, component macro/worst false REAL alarms and AI recall, and exact paired rescued/new errors. The fixed.5 cut is a diagnostic default, not calibrated confidence or the E92 operating threshold. Pooled scores come from different fold models; none is a deployable candidate. Three AI-bearing groups and unknown encoder-pretraining ancestry sharply limit the conclusions. Do not call this a20-gate pass or a fresh-final test.

Use existing feature arrays, no image reread or download. Bound execution to7200seconds/2CPU threads and preserve partial outputs on failure. Run after the current GPU/memory-intensive pipeline has released resources. This answers whether the new representations transfer across declared source groups, beyond already-perfect full-TRAIN decisions; results will guide a new hypothesis, not another adjustment to the known DEV miss.
