...
txt(s,'Owner gallery: 206 unique real-image files',72,170,1136,55,34,true);
txt(s,'False AI alerts: 9 originals; 18 social-style views\nPreviously inspected, mostly one phone and correlated scenes',72,243,1136,105,29);
txt(s,'Later research candidates were rejected',72,399,1136,55,34,true);
txt(s,'Source-fold evaluation failed the complete requirements.\nNew source-pixel features harmed transported AI recall.',72,472,1136,105,29);
speak(s,9,'Broader reliability',60,'The practical gallery check found nine false alerts in two hundred six unique original real files, and eighteen after processing. That collection had already been inspected and mostly represents one phone, so it is a diagnostic, not independent accuracy. Later source-separated experiments used different research heads. No tested calibration assignment met the full evaluation conditions. Adding source-pixel features slightly improved clean aggregates but harmed AI recall after several transformations. Those candidates were rejected instead of replacing E92. These results identify remaining weaknesses; they do not provide a new E92 accuracy estimate. Sources: E95, E146, E151 and E152.');
