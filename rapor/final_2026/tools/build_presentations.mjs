...
txt(s,'9/206 originals; 18/206 processed copies\nConsumed data, mostly one phone and correlated scenes',72,422,1136,100,28);
...
txt(s,'Table 4 compares edit placement on 16 consumed parents.',72,153,1136,60,29);
table(s,'Table 4. Localization trade-off, original-image condition.',[['Measure','Earlier head','Two-placement head'],['Original-placement pixel AUC','0.742','0.699'],['New-placement pixel AUC','0.566','0.638'],['Authentic falsely flagged area','17.11%','25.74%']],[585,245,306],280,260);
