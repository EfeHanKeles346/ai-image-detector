...
E127 verification: all 998 Python tests passed (one existing Starlette/httpx deprecation warning). Whitespace checks passed. E124 remained the sole GPU experiment throughout; at the checkpoint it had completed 4,050/12,525 TRAIN parents with maximum pilot replay error 0. E126 remained waiting for the complete upstream lifecycle; AC power was connected. This checkpoint is extraction progress, not a measured detection gain.

### Overnight continuation started — 2026-09-15

At 21:58:48 UTC the user-confirmed nine-hour continuous session began, with no recurring scheduler. E124 was running (8,850/12,525 parents, pilot replay error0), E126 was waiting, Git was clean and AC power was connected. A read-only view of one E119 authentic native crop suggested limited scene context and strong high-frequency colour variation. Registered the proposed same-parent resized-context E128/E129 ablation in PLAN before any new derived pixels or generation. This observation does not establish the cause of five E122 safety rejections.

### E128 completed / E129 registered — 2026-09-15

E128 prepared all16 same-parent resized-context inputs and paired classical controls in5.25seconds, preserving masks/seeds/roles. Input manifest SHA d2114aee3c1c2fa579bb1db25cf456beaf571119b6d080405f41d773ce785dcb;32 new PNGs total15,370,680bytes, no downloads. Texture-proxy means0.038142 native crop /0.032809 resized context, descriptive only. E129 is frozen with the identical E122 fp16+SDPA generation recipe and complete16/16 gate; no output-dependent refill, filter bypass or automatic TRAIN admission. Twelve geometry/ancestry/paired-outcome tests and four dependency tests passed before execution. Its one-shot dependent runner waits for E124/E125/E126 and verifies/restores the exact E92 artifact with the base API environment.

E128/E129 verification: all1,014 Python tests passed (one existing Starlette/httpx deprecation warning). E128 and E129 contracts are frozen, the finite Model2 replay is waiting for Model1 GPU release, and no new generation has run yet. DND source review confirmed non-commercial research terms but a required login for official downloads; no account or download was attempted. Continue with anonymously accessible, author-linked sources and already-local data.

2026-09-15: Recorded SIDL public archive quota response and exact HTML receipts; zero image bytes, no quota bypass or admission. DND official metadata/terms reviewed, login required; no acquisition. Continue existing-data experiments. Details in DATASETS.md.
...
2026-09-15: Corrected README entrypoint guidance: current local demo is E92 via internship_serve; legacy E20–E32 instructions/results are explicitly historical. Ongoing experiment/status records remain only the four canonical English files. No serving implementation or model artifact changed.
...
2026-09-15: Added a compact current execution overview near the top of PLAN.md to distinguish completed features, pending model evaluations and prototype diagnostics from the long dated history. No scientific gate or data role changed.
