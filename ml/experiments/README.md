...
| `e31_train_v2.py` | active TRAIN-v2 contract | Metadata-only exact row freeze followed by full selected-row protected-content hashing and deterministic native-tile realization |
